...
osThreadId_t taskWaveHandle;
const osThreadAttr_t taskWave_attributes = {
  .name = "taskWave",
  .stack_size = 256 * 4,
  .priority = (osPriority_t) osPriorityNormal,
};
...
/* Definitions for waveSema */
osSemaphoreId_t waveSemaHandle;
const osSemaphoreAttr_t waveSema_attributes = {
  .name = "waveSema"
};
/* USER CODE BEGIN PV */
...
/* USER CODE BEGIN Header_StartTaskEsp32 */
/**
* @brief Function implementing the taskEsp32 thread.
* @param argument: Not used
* @retval None
*/
...
//    osDelay(1);
  ...
  /* USER CODE END StartTaskEsp32 */
}

/* USER CODE BEGIN Header_StartTaskWave */
/**
* @brief Function implementing the taskWave thread.
* @param argument: Not used
* @retval None
*/
